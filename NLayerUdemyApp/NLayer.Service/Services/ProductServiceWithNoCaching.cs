...
namespace NLayer.Service.Services
{
...

    {
        ...
        public ProductServiceWithNoCaching(IGenericRepository<ProductEntity> repository, IUnitOfWorks unitOfWorks, IProductRepository productRepository, IMapper mapper) : base(repository, unitOfWorks)
        {
